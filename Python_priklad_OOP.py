...
Uprav cyklus, aby započítal hodnotu pouze těch balíků, které jsou ve stavu nedoručen. Je třeba pro čtení použít některou
 z funkcí isinstance(), hasattr() nebo getattr()."""
class Package:
